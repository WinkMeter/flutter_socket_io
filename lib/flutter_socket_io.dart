...
import 'package:flutter_socket_io/iflutter_socket_io.dart';
...
class SocketIO implements ISocketIO {
  ...
  /// socketStatusCallback [optional]: the status of socket will be sent into this function
  SocketIO(String domain, String namespace, {String query, Function socketStatusCallback}) {
    ...
    _channel.setMethodCallHandler(handlerMethodCall);
    _callbacks = new Map();
  }
  ...
  Future<dynamic> handlerMethodCall(MethodCall call) {
...
//              return null;
  ...
  @override
  void subscribe(String event, Function callback) async {
    if (event != null && event.isNotEmpty) {
      CallbackFunctions functions = _callbacks[event];
      SocketIOFunction f;
  ...
  @override
  void unSubscribe(String event, [Function callback]) async {
  ...
  @override
  void sendMessage(String event, dynamic message, [Function callback]) async {
    if (event != null && event.isNotEmpty) {
      CallbackFunctions functions = _callbacks[event];
      SocketIOFunction f;
